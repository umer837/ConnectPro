        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">All service providers are thoroughly vetted and approved by our admin team.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Your personal information and communications are protected and secure.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/register"
              className="bg-blue-700 text-white px-8 py-3 rounded-md font-semibold hover:bg-blue-800 transition-colors border border-blue-500"
            >
              Become a Provider
            </a>
          </div>
